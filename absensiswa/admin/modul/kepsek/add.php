<div class="page-inner">
          ...
          <div class="row">
            ...
            <div class="form-group">
								<label>ID KEPSEK</label>
								<input name="id_kepsek" type="text" class="form-control" placeholder="Id Kepsek">								
							</div>
							<div class="form-group">
              ...
              <div class="form-group">
								<label>Status</label>
								<input name="status" type="text" class="form-control" placeholder="Y/T">								
							</div>
