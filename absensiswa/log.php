...
<head>
    ...
    <link rel="icon" href="assets/img/merdeka.png" type="image/x-icon" />
        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/merdeka.png" alt="navbar brand" class="navbar-brand" width="40">
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                ...
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Kp. Kertangera RT/RW 015/007
                                        Ds. Kertangera Kec. Haurgeulis Kab. Indramayu 45642 Prov. Jawa Barat</a>
