        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/siswa.jpg" alt="">
            </div>
          </div>
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Tentang Website Ini</h1>
              <p>Website ini berfungsi sebagai absensi siswa.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">mdinalayubi </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">082317751464</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Muhammad Din Al Ayubi</p>
              </div>
            </div>
          </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class=" " aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">mdinalayubi</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
				<div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
					<a href="https://www.facebook.com/Muhammad Din Al Ayubi/" target="_blank"><i class="fab fa-facebook-f"></i></a>
					<a href="https://github.com/mdinalayubi" target="_blank"><i class="fab fa-github"></i></a>
					<a href="www.linkedin.com/in/muhammad-din-al-ayubi-2b6825291" target="_blank" ><i class="fab fa-linkedin" target="_blank"></i></a>
